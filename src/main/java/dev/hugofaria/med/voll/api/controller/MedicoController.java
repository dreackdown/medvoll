...
import dev.hugofaria.med.voll.api.domain.medico.DadosAtualizacaoMedico;
import dev.hugofaria.med.voll.api.domain.medico.DadosCadastroMedico;
import dev.hugofaria.med.voll.api.domain.medico.DadosListagemMedico;
import dev.hugofaria.med.voll.api.domain.medico.DadosDetalhamentoMedico;
import dev.hugofaria.med.voll.api.domain.medico.MedicoRepository;
import io.swagger.v3.oas.annotations.security.SecurityRequirement;
import jakarta.transaction.Transactional;
import jakarta.validation.Valid;
import dev.hugofaria.med.voll.api.domain.medico.Medico;
